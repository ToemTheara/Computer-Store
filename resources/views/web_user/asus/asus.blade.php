    ...
    @section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="list-group text-center">
                        ...
                        <a href="/asus" class="list-group-item"><button class="btn btn-outline-primary ">ASUS COMPUTER</button></a>
                    </div>
                </div>
            <!-- /.col-lg-3 -->
            ...
            <div class="col-lg-9">
                ...
                <div>
                    <button class="btn btn-outline-primary ">ASUS Computer>>></button>
                </div>
                    <div class="row">
                        @foreach ($asuses as $asus)
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="card h-100">
                                <a href="/asus_detail/{{$asus->computer_id}}"><img class="card-img-top" src="storage/images/{{$asus->image}}" alt="Computer"></a>
                                <div class="card-body">
                                    <h4 class="card-title">
                                    <a href="/asus_detail/{{$asus->computer_id}}">{{$asus->name}}</a>
                                    </h4>
                                    <h5>${{$asus->price}}</h5>
