                    ...
                    <div class="row">
                        @foreach ($lenovos as $lenovo)
                            <div class="col-lg-4 col-md-6 mb-4">
                                ...
                                <a href="/lenovo_detail/{{$lenovo->computer_id}}"><img class="card-img-top" src="storage/images/{{$lenovo->image}}" alt="Computer"></a>
                                <div class="card-body">
                                    <h4 class="card-title">
                                    <a href="/lenovo_detail/{{$lenovo->computer_id}}">{{$lenovo->name}}</a>
                                    </h4>
                                    <h5>${{$lenovo->price}}</h5>
