            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="list-group text-center">
                        <a href="/" class="list-group-item"><button class="btn btn-outline-primary ">ALL COMPUTER</button></a>
                                ...
                                <div class="container-fliud">
                                            <div class="wrapper row">
                                                ...
                                                <div class="details col-md-6">
                                                    ...
                                                    <h5 class="price">Price: <span>${{$computer->price}}</span></h5>
                                                    ...
                                                    <div class="action">
                                                        <a href="/"><button class="btn btn-outline-danger" type="button"> <<< Back</button></a>
                                                    </div>
                                                </div>
                                            </div>
